/*
 * $Id: ProxyPage.java 12 2005-01-07 05:33:54Z rcleveng $
 */
...
public class ProxyPage extends JPanel implements PreferencesPage {
	...
	private void jbInit() throws Exception {
		...
		this.add(chkUseProxy, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST,
				GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		this.add(lblProxyName, new GridBagConstraints(0, 1, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST,
				GridBagConstraints.HORIZONTAL, new Insets(5, 15, 5, 5), 0, 0));
		this.add(taProxyHostName, new GridBagConstraints(0, 2, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST,
				GridBagConstraints.HORIZONTAL, new Insets(5, 15, 5, 5), 0, 0));
		this.add(lblProxyPort, new GridBagConstraints(0, 3, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST,
				GridBagConstraints.HORIZONTAL, new Insets(5, 15, 5, 5), 0, 0));
		this.add(taProxyPort, new GridBagConstraints(0, 4, 1, 1, 1.0, 1.0, GridBagConstraints.NORTHWEST,
				GridBagConstraints.HORIZONTAL, new Insets(5, 15, 5, 5), 0, 0));
	}
