/*
 * $Id: GeneralPage.java 12 2005-01-07 05:33:54Z rcleveng $
 */
...
public class GeneralPage extends JPanel implements PreferencesPage {
	...
	private void jbInit() throws Exception {
		...
		this.add(lblToolbar, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST,
				GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 5), 0, 0));
		this.add(radioTextBelow, new GridBagConstraints(0, 3, 1, 1, 1.0, 1.0, GridBagConstraints.NORTHWEST,
				GridBagConstraints.HORIZONTAL, new Insets(5, 20, 5, 5), 0, 0));
		this.add(radioTextRight, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST,
				GridBagConstraints.HORIZONTAL, new Insets(5, 20, 5, 5), 0, 0));
		this.add(chkUseToolbarText, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST,
