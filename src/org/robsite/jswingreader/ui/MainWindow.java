/*
 * $Id: MainWindow.java 12 2005-01-07 05:33:54Z rcleveng $
 */
...
public final class MainWindow extends JFrame {
	...
	private void postInit() {
		this.addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				ActionEvent actionEvent = new ActionEvent(this, ActionEvent.ACTION_FIRST,
	...
	private void channel_ValueChanged(JList channelList, JList itemList) {
		...
		itemsModel.clear();
		Iterator iter = (channel.getItems() != null) ? channel.getItems().iterator()
